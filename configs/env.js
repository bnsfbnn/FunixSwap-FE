const EnvConfig = {
  RPC_ENDPOINT: 'https://localhost:8545',
  TOKEN_ABI: [
    {
      "inputs": [
        {
  ...
  EXCHANGE_CONTRACT_ADDRESS: '0xc5BEE774F2BeCD833eF785d1Ba2D31Ea81D22066',
  /* END DONE */
  ...
  TOKENS: [
    ...
    /* DONE: Change to your own deployed tokens. Remember to put 2 tokens here to support token to token swapping */
    {
      "name": 'Token1',
      "symbol": 'TK1',
      address: '0x062De750b17EB665ECf72671333249439e1d19C9',
    },
    {
      "name": 'Token2',
      "symbol": 'TK2',
      address: '0x3ccE566cCEdb2FB79353d47a4896c07bD67219ca',
    },
    /* END DONE */
